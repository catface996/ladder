...
- 分布式系统的前世
  id:: 6273b82c-d6a4-479f-b7ea-c8061f1ac0f9
	- C/S 架构和 B/S 架构
		- ![image.png](../assets/image_1652220211434_0.png)
		- C/S 缺点
			- 平台兼容性Windows，Linux
...
- 分布式系统面临的问题
	- 通信异常：网络本身是不可靠的。
	- 网络分区：网络与网络之间出现无法通信的情况，但是子网内部的网络是正常的。
	- 节点故障：硬件故障，节点的操作系统崩溃。
	- 三种请求应答状态：成功，失败和超时。
- 分布式系统分类
	- 分布式存储
...
- 分布式系统的扩展
	- x轴方向扩展
		- ![image.png](../assets/image_1652220998260_0.png)
		- 解决的问题
			- 为了解决单机无法满足大量并发请求，CPU ，内存有限
		- 特点
			- 对同一个应用扩展出多个副本
		...
		- 对应的技术
			...
			- 资源编排
			  collapsed:: true
				- [[Kubernetes]]
	- y轴方向扩展  --进入微服务时代
		- ![image.png](../assets/image_1652256847583_0.png)
		- 解决的问题
			- 为了解决x轴扩展的数据缓存层和数据库层的处理能力的上限，支持数据库的水平扩展。
		- 特点
			- 按照业务领域拆分成多个应用。
		...
		- 对应的技术
			...
			- 配置中心
			  collapsed:: true
				...
				- Apollo
	- z轴方向扩展
		- ![image.png](../assets/image_1652256894053_0.png)
		- 解决的问题
